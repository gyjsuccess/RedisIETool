...
import com.d5.redis.client.domain.Language;

public class ConfigFile extends PropertyFile {
	private final static String propertyFile = System.getProperty("CONF_HOME") + File.separatorChar + "RedisClient.properties";
